...
async function generateUniqueSlug(sql: any, title: string, table: 'articles' | 'resources'): Promise<string> {
...
export { generateSlugsForArticles, generateSlugsForResources, generateUniqueSlug };